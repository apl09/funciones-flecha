...
//Imprimir los números del 1 al 20 en la consola, pero para los múltiplos de 3 imprimir 
//"Fizz", para los múltiplos de 5 imprimir "Buzz" y para los múltiplos de ambos imprimir "FizzBuzz".

const fizzBuzz = array.map(numero => {
    if ( numero %15 == 0  ){
        return 'FizzBuzz'
    } else if (numero %3 == 0){
        return 'Fizz'
...
const numeroGrande = array.map(numero => {    
    return Math.max(numero)

}) 

const numeroPequeño = array.map(numero => {    
